...
export const STAGES: Array<{ name: string, maskKeys: Array<keyof LogoParams>, params: Array<{id: keyof LogoParams, step: number}> }> = [
  ...
  },
  {
    ...
    params: [
      ...
      { id: 'nsewDecorationDistance', step: 1 },
      { id: 'diagonalDecorationDistance', step: 1 },
      { id: 'nsewDecorationLength', step: 1 },
      { id: 'nsewDecorationWidth', step: 1 },
      { id: 'nsewDecorationConcavity', step: 0.1 },
      { id: 'nsewDecorationThirdBumpDistance', step: 0.5 },
      { id: 'nsewDecorationThirdBumpRadius', step: 0.5 },
      { id: 'diagonalDecorationWidth', step: 1 },
    ],
  },
];
...
export async function runOptimization(updateFn: () => void, stagesToRun = STAGES): Promise<void> {
  if (!referenceImage) {
