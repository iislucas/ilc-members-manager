...
exports.FLOWS_CATALOG = [
    ...
    },
    {
        ...
        summary: 'The flow from initiating a checkout session for memberships, tickets, or gradings through Stripe payment settlement, webhook validation, and automated fulfillment.',
    ...
    },
    {
        ...
        summary: 'Automated pipeline from master video file upload in GCS to GCP Transcoder API, multi-bitrate HLS generation, access token authorization, and offline player caching.',
