...
import { DataTypeEntry, DataDomainGroup } from '../models/data-type';

export const DATA_TYPES_CATALOG: DataTypeEntry[] = [
  {
    id: 'member',
    name: 'Member',
    domain: DataDomainGroup.IdentityAuth,
  ...
  },
  {
    id: 'grading',
    name: 'Grading',
    domain: DataDomainGroup.CurriculumGrading,
    collectionPath: '/gradings/{docId}',
    isSubcollection: false,
    sourceFile: 'functions/src/data-model/gradings.ts',
    summary:
      'A formal examination record tracking a member grading attempt, fee settlement, examiner evaluation, and progression milestone.',
    ...
    rulesSummary:
      'Strict field-level validation via affectedKeys().hasOnly(...). Managers can approve and set status; students can change event until finalized.',
  ...
  },
  {
    id: 'ilc-event',
    name: 'IlcEvent',
    domain: DataDomainGroup.EventsTicketing,
    collectionPath: '/events/{docId}',
    isSubcollection: false,
    sourceFile: 'functions/src/data-model/events.ts',
    summary:
      'A workshop, retreat, class series, or grading seminar hosted by HQ, a school, or certified instructor.',
  ...
  },
  {
    ...
    sourceFile: 'functions/src/data-model/events.ts',
    summary:
      'Attendee ticket registration record capturing ticket tier, payment confirmation, and attendance status.',
  ...
  },
  {
    id: 'school',
    name: 'School',
    domain: DataDomainGroup.OrganizationSchool,
    collectionPath: '/schools/{docId}',
    isSubcollection: false,
    sourceFile: 'functions/src/data-model/schools.ts',
    summary:
      'An official affiliate school or training group operating under the auspices of I Liq Chuan.',
  ...
  },
  {
    ...
    sourceFile: 'functions/src/data-model/members.ts',
    summary:
      'Public instructor directory entry mirrored automatically from certified Member profiles.',
  ...
  },
  {
    ...
    summary:
      'Curated Video on Demand (VOD) catalog entry for instructional tutorials, workshops, and class video library recordings.',
  ...
  },
  {
    ...
    sourceFile: 'functions/src/data-model/vod.ts',
    summary:
      'Playback resume state and completion marker for a member on a specific video.',
  ...
  },
  {
    id: 'order',
    name: 'Order',
    domain: DataDomainGroup.CommerceFulfillment,
    collectionPath: '/orders/{docId}',
    isSubcollection: false,
    sourceFile: 'functions/src/data-model/orders.ts',
    summary:
      'A financial transaction record representing an e-commerce checkout, subscription invoice, or imported legacy order.',
  ...
  },
  {
    ...
    summary:
      'Fast-lookup authorization document keyed by lowercase login email caching global roles, member docIds, and license expirations.',
  ...
  },
  {
    ...
    sourceFile: 'functions/src/data-model/events.ts',
    summary:
      'Pricing model and tier definition for event tickets, annual memberships, instructor licenses, and video purchases.',
  ...
  },
  {
    id: 'post',
    name: 'Post',
    domain: DataDomainGroup.CommunityContent,
    collectionPath: '/members-post/{id}',
    isSubcollection: false,
    sourceFile: 'functions/src/data-model/content-cache.ts',
    summary:
      'Community announcement, training article, or instructor message.',
  ...
  },
  {
    ...
    sourceFile: 'functions/src/data-model/system.ts',
    summary:
      'Global sequence counters, country code registries, and synchronization cache timestamps.',
