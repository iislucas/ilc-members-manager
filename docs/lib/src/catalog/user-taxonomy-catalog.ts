...
export const USER_TAXONOMY_TREE: UserTaxonomyNode[] = [
  {
    ...
    category: TaxonomyCategory.PublicAndProspective,
  ...
  },
  {
    ...
    category: TaxonomyCategory.MembersAndPractitioners,
  ...
  },
  {
    ...
    category: TaxonomyCategory.CertifiedInstructors,
  ...
  },
  {
    ...
    category: TaxonomyCategory.InstitutionalAndEvents,
  ...
  },
  {
    ...
    category: TaxonomyCategory.GovernanceAndSystem,
...
export function flattenTaxonomy(nodes: UserTaxonomyNode[] = USER_TAXONOMY_TREE): UserTaxonomyNode[] {
  const result: UserTaxonomyNode[] = [];
...
export function findTaxonomyNode(id: string, nodes: UserTaxonomyNode[] = USER_TAXONOMY_TREE): UserTaxonomyNode | undefined {
  for (const node of nodes) {
