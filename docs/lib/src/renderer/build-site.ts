...
import { DATA_TYPES_CATALOG } from '../catalog/data-types-catalog';
import { USER_JOURNEYS_CATALOG, SITE_SURFACE_MAP } from '../catalog/journeys-catalog';
import { PLANS_CATALOG } from '../catalog/plans-catalog';
import { STORIES_CATALOG } from '../catalog/stories-catalog';
import { FLOWS_CATALOG } from '../catalog/flows-catalog';
import { SETUP_CATALOG } from '../catalog/setup-catalog';
import { PATTERNS_CATALOG } from '../catalog/patterns-catalog';
import { FILES_CATALOG } from '../catalog/files-catalog';
import { CodeLinkResolver } from '../resolvers/code-link-resolver';
import { DocsSearchIndex, SearchDoc } from '../search/docs-search-index';
...
function generateSearchIndex(): string {
  ...
  // Journeys
  USER_JOURNEYS_CATALOG.forEach((j) => {
    searchDocs.push({
      id: `journey-${j.id}`,
      view: 'journeys',
      title: j.title,
