...
export const getMembers = onCall<unknown, Promise<FetchMembersResult>>(
  ...
  async (request) => {
    ...
    const userKind = await getUserDetailsHelper(request);
    ...
    try {
      ...
      if (memberData.isAdmin) {
        ...
        return { members, schoolsManaged: [...schoolIds], isAdmin: true };
      }
      ...
      if (schoolIds.size > 0) {
        ...
        return { members, schoolsManaged: [...schoolIds], isAdmin: false };
      }
