...
export enum Views {
  ...
  InstructorsAreaPostEdit = 'instructorsAreaPostEdit',
  InstructorsAreaPostNew = 'instructorsAreaPostNew',
  Articles = 'articles',
  ArticlesCategory = 'articlesCategory',
  ArticlesPost = 'articlesPost',
  ArticlesPostEdit = 'articlesPostEdit',
  ArticlesPostNew = 'articlesPostNew',
  ...
  MembersAreaPostEdit = 'membersAreaPostEdit',
  MembersAreaPostNew = 'membersAreaPostNew',
  MyProfile = 'myProfile',
  MySchools = 'mySchools',
...
export const initPathPatterns = {
  ...
  [Views.MembersAreaPostEdit]: pathPattern`members-area/post/${pv('blogPostPath')}/edit`,
  [Views.MembersAreaPostNew]: pathPattern`members-area/new`,
  [Views.InstructorsAreaPost]: pathPattern`instructors-area/post/${pv('blogPostPath')}`,
  [Views.InstructorsAreaPostEdit]: pathPattern`instructors-area/post/${pv('blogPostPath')}/edit`,
  [Views.InstructorsAreaPostNew]: pathPattern`instructors-area/new`,
  [Views.ArticlesPost]: pathPattern`articles/post/${pv('blogPostPath')}`,
  [Views.ArticlesPostEdit]: pathPattern`articles/post/${pv('blogPostPath')}/edit`,
  [Views.ArticlesPostNew]: pathPattern`articles/new`,
